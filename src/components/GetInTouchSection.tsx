...
const socials = [
  { icon: Mail, href: "mailto:scentoftimebd2025@gmail.com", label: "Email" },
  { icon: Facebook, href: "https://www.facebook.com/scentoftimebangladesh", label: "Facebook" },
  { icon: Instagram, href: "https://www.instagram.com/scent_of_time_/", label: "Instagram" },
  {
    icon: () => (
    ...
    href: "https://www.tiktok.com/@scentoftime__",
    label: "TikTok",
  },
  {
    icon: () => (
    ...
    href: "https://wa.me/+8801326155276",
    label: "WhatsApp",
  },
];
...
const hotlines = [
  ...
  { number: "01817891704", whatsapp: "8801817891704" },
];
